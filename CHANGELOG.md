...
- Enhancement: Allow new pluginDefinition webContent destination variable for substitution, ZOWE_REFERRER_HOST_PORT which cannot be combined with other variables but will return the destination is matching the request's referrer domain
