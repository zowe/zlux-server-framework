...
const log = (global as any).COM_RS_COMMON_LOGGER.makeComponentLogger("_unp.json");

function JSONUtils(){

}

export function readJSONFileWithComments(filename: any){
...
export function parseJSONWithComments(filename: any) {
  return (JSONUtils as any).readJSONFileWithComments(filename);
};
