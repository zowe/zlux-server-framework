...
export class DependencyGraph {
  ...
  _removeBrokenPlugins(graphWithBrokenDeps: any) {
    ...
    function visit(pluginNode: any, validationError: any) {
 ...
 */
// function DependencyGraph(initialPlugins: any) {
//   this.pluginsById = {};
//   for (const p of initialPlugins) {
//     this.addPlugin(p);
//   }
