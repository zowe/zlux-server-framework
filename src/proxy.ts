...
export function convertOptions(request: any, realHost: any, realPort: any, urlPrefix: any) {
  var options: any = {};
...
export function makeSimpleProxy(host: any, port: any, options: any, pluginID: any, serviceName: any) {
  if (!(host && port)) {
