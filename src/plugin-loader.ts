...
const translationUtils = require('./translation-utils.ts');
...
function makeDataService(def: any, plugin: any, context: any) {
  ...
  if (def.type == "external") {
    dataservice = new (ExternalService as any)(def, configuration, plugin);
  } else if (def.type == "import") {
    dataservice = new (Import as any)(def, configuration, plugin);
  } else if ((def.type == 'nodeService')
        || (def.type === 'router')) {
    dataservice = new (NodeService as any)(def, configuration, plugin);
  } else {
    dataservice = new (Service as any)(def, configuration, plugin);
  }
...
export class Plugin{
  ...
  initDataServices(context: any) {
    function addService(service: any, name: any, container: any) {
...
function makePlugin(def: any, pluginConfiguration: any, pluginContext: any, dynamicallyCreated: any) {
...
// }
// function Service(def: any, configuration: any, plugin: any) {
//   this.configuration = configuration;
//   //don't do this here: avoid circular structures:
//   //this.plugin = plugin; 
//   Object.assign(this, def);
...
// function Import(def: any, configuration: any, plugin: any) {
...
// function NodeService(def: any, configuration: any, plugin: any) {
//   Service.call(this, def, configuration, plugin);
// }
...
// function ExternalService(def: any, configuration: any, plugin: any) {
//   Service.call(this, def, configuration, plugin);
//   if (!this.host) {
//     this.host = plugin.host;
//   }
...
// function Plugin(def: any, configuration: any) {
//   Object.assign(this, def);
//   this.configuration = configuration;
//   if (!this.location) {
//     this.location = process.cwd();
...
// function LibraryPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function ApplicationPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function WindowManagerPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function BootstrapPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function DesktopPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function NodeAuthenticationPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
// }
...
// function ProxyConnectorPlugIn(def: any, configuration: any) {
//   Plugin.call(this, def, configuration);
//   const remoteConfig = configuration.getContents(["remote.json"]);
//   if (remoteConfig) {
//     if (!this.host) {
...
// function PluginLoader(options: any) {
//   EventEmitter.call(this);
//   this.options = zluxUtil.makeOptionsObject(defaultOptions, options);
//   this.plugins = [];
//   this.pluginMap = {};
...
(PluginLoader as any).makePlugin = makePlugin;
