  ...
  return process.clusterManager.getStorage().then( function(clusterStorage) {
    ...
    clusterStorage.getStorage = function () {
      return process.clusterManager.getStorage().then((storage) => {
        clusterStorage.storageDict = storage.storageDict;
    ...
    clusterStorage.addStorage = function (dict) {
      clusterStorage.storageDict = { ...clusterStorage.storageDict, ...dict };
      process.clusterManager.addStorage(dict);
    }
    ...
    contentLogger.debug("App context is loaded with storage object: ", clusterStorage);
