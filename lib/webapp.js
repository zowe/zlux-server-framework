...
function DataserviceContext(serviceDefinition, serviceConfiguration, 
  ...
  this.storageV2 = pluginStorage.PluginStorageFactory(this.plugin.pluginDef.identifier);

  /* 
  === V1 storage - to be deprecated as a plugin API as it only uses sync commands, HA cannot participate. ===
  === V1 storage will remain for internal use by clusterManager                                           ===
  ...
  this.storage = pluginStorage.LocalStorageFactory(this.plugin.pluginDef.identifier);
  this.storageV1 = this.storage;
  ...
  /*
  === V1 storage - to be deprecated as it only uses sync commands, HA cannot participate. ===
  */
