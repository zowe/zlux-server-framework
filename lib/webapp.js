 ...
 */
function WebServiceHandle(urlPrefix, environment, service) {
...
WebServiceHandle.prototype = {
  ...
  call(path, options, originalRequest, originalRes) {
    return new Promise((resolve, reject) => {
      ...
      let httpOrHttps;
      if ((typeof this.service === 'object' && (this.service.type === 'external' || this.service.type === 'service')) || (typeof this.service === 'boolean' && this.service)) {
        if(this.service.type === 'external') {
  ...
  _makeServiceHandleMap(plugin, urlBase) {
    ...
    for (const group of zluxUtil.concatIterables(
      ...
      for (const version of Object.keys(group.versions)) {
        ...
        const handle = new WebServiceHandle(subUrl, this.wsEnvironment, service);
