...
const staticHandlers = {
  ...
  server(options){
    ...
    const agentSwaggerBaseUrl = `${zLuxUrl.makePluginURL('zlux', zluxUtil.agentSwaggerPlugin)}/catalogs/swagger`;
  ...
  swagger(productCode) {
    ...
    const agentSwaggerBaseUrl = `${zLuxUrl.makePluginURL(productCode, agentSwaggerPlugin)}/catalogs/swagger`;
