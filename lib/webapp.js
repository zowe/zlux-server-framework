...
function do404(URL, res, message) {
  ...
  // HTML-escape both URL and message to prevent reflected XSS
  ...
  res.status(404).send("<h1>Resource not found, URL: "+safeURL+"</h1></br><h2>Additional info: "+safeMessage+"</h2>");
}
