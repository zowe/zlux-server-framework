...
WebApp.prototype = {
  ...
  installRootServices() {
    ...
    this._installRootService('/pid', 'get', staticHandlers.plugins(this), 
        {needJson: false, needAuth: true, authType: "semi", isPseudoSso: false}); 
    this._installRootService('/pid', 'use', staticHandlers.getPid(),
      {needJson: true, needAuth: true, isPseudoSso: false});
    serviceHandleMap['pid'] = new WebServiceHandle('/pid', this.wsEnvironment);
