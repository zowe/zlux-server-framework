...
function DataserviceContext(serviceDefinition, serviceConfiguration, 
  ...
  this.storage = new DataserviceStorage();
...
function DataserviceStorage() {
  this.storageDict = new Object;
}

DataserviceStorage.prototype.setObject = function (id, value) {
  this.storageDict[id] = value;
}

DataserviceStorage.prototype.getObject = function (id) {
  return this.storageDict[id];
}

DataserviceStorage.prototype.deleteObject = function (id) {
