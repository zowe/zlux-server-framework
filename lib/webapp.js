...
const staticHandlers = {
  ...
  jwtSecret: function(webapp) {
    const secret = [
      "-----BEGIN CERTIFICATE-----",
      "MIIDoTCCAomgAwIBAgIEbDJ5IDANBgkqhkiG9w0BAQsFADCBgDELMAkGA1UEBhMC",
      "Q1oxDzANBgNVBAgTBlByYWd1ZTEPMA0GA1UEBxMGUHJhZ3VlMRQwEgYDVQQKEwta",
      "b3dlIFNhbXBsZTEcMBoGA1UECxMTQVBJIE1lZGlhdGlvbiBMYXllcjEbMBkGA1UE",
      "AxMSWm93ZSBTZXJ2aWNlIC0gSldUMB4XDTIxMDYwMTA0MzQwNVoXDTMxMDUzMDA0",
      "MzQwNVowgYAxCzAJBgNVBAYTAkNaMQ8wDQYDVQQIEwZQcmFndWUxDzANBgNVBAcT",
      "BlByYWd1ZTEUMBIGA1UEChMLWm93ZSBTYW1wbGUxHDAaBgNVBAsTE0FQSSBNZWRp",
      "YXRpb24gTGF5ZXIxGzAZBgNVBAMTElpvd2UgU2VydmljZSAtIEpXVDCCASIwDQYJ",
      "KoZIhvcNAQEBBQADggEPADCCAQoCggEBAN9ORygd9Gb5rHGR79CCnT5tGvUsUqzf",
      "cFiRGKPULkqHEG2D0JD9UEreK/KBpGw/NoMwzqYRKIE56SdgMsyOxbL6H7QDgiyX",
      "LehNxqbVx3w9aCglrR7hGHVRXPmTPZ+KUlRK4X5ss26qPPbbs5vRxD9ePIevJAyv",
      "sz21uEEAupgI1XWbkV8mZMU2tsqQepUwsnHtYJZiu8siXNPSymFAn48IlRC+yucZ",
      "myFlSucJBFksaAYerXUUIJHnqBmzd7yBHLHNgrgEa8oZjpw4NUVFqvsCfgWGVgfg",
      "6v+qO9EGb/Me22cC7XWF5797GhN5r65k+krPfSzCJEvP4or7H4zqVVMCAwEAAaMh",
      "MB8wHQYDVR0OBBYEFG0JapJ5M55sl4o1xRs7YVRPSW62MA0GCSqGSIb3DQEBCwUA",
      "A4IBAQC6prHvE8qwAR3dnNLzdPAm7aV0NnK73jAWlBNwyXTGcFmbLpEBmVeDURNU",
      "HRMCAfC14lIwKxeru7bOPxI2g2sqdy338MIyLvgD2Bw6QSaY4kDCLFOFcNYfI7LQ",
      "Jm+5iiBkP2bAE+w61nlgijXGndMNAtkEhDV47aX1+H42GHTn3OAmgCywiUGZy6ha",
      "emPub6j1tdYqyJGltPN31yOXGjkcmQw37euhQo5xayW12pYyEk18X4r+R/2DSs94",
      "3qwYZ9+3i+o4I+M62kI9Vrrf91sOuQ8Ifm/7AvhSJytuuaBArtAWPNwVvKznh6rQ",
      "HohGjNfTyTCF0WGQlr2lOGEp8gjc",
      "-----END CERTIFICATE-----"
    ].join('\n');
    return function(_req, res) {
      res.status(200).set({'Content-Type': 'text/plain'}).send(secret);
    };
  },
...
WebApp.prototype = {
  ...
  installRootServices() {
    ...
    this._installRootService('/jwtsecret', 'get', staticHandlers.jwtSecret(this), 
        {needJson: false, needAuth: false, authType: "semi", isPseudoSso: false}); 
