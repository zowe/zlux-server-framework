...
const staticHandlers = {
  ...
  server(options){
    ...
    const rbac = options.componentConfig.dataserviceAuth.rbac === true;
...
function WebApp(options){
  ...
  this.loopbackConfig = {
    ...
    host: this.componentConfig.node.loopbackAddress
      ...
      : zluxUtil.getLoopbackAddress(zluxUtil.getHttpsListeningAddresses(this.zoweConfig) ||zluxUtil.getHttpListeningAddresses(this.zoweConfig))
  };
