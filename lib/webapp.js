...
// Regex to identify the sensitive keys
const SENSITIVE_KEY_PATTERN = /PASS|SECRET|KEY|TOKEN/i;
...
// clones the environment variables by replacing the sensitive values
function getSanitizedEnv(env) {
  const sanitized = {};
  ...
  return new Promise(function(resolve, reject){
    ...
    if (rbac) {
      resolve({
        ...
        "hostname": hostname,
        "userEnvironment": getSanitizedEnv(process.env),
