...
if (cluster.isMaster) {
  ...
  ClusterManager.prototype.setStorageValue = function(pluginId, id, value, resultHandler) {
    if (this.storage) {
      this.storage.setStorageValue(id, value, pluginId);
  ...
  ClusterManager.prototype.setStorage = function(pluginId, dict, resultHandler) {
    if (this.storage) {
      this.storage.setStorage(dict, pluginId);
      return resultHandler(true);
    } else {
  ...
  ClusterManager.prototype.addStorage = function(pluginId, dict, resultHandler) {
    if (this.storage) {
      const mergedObjects = mergeUtils.deepAssign(this.storage.getStorage(pluginId), dict);
      this.storage.setStorage(mergedObjects, pluginId);
      return resultHandler(true);
    } else {
  ...
  ClusterManager.prototype.getStorageValue = function(id, resultHandler) {
    if (this.storage) {
      return resultHandler(this.storage.getStorageValue(id, pluginId));
    } else {
      return resultHandler(null);
    }
  }

  ClusterManager.prototype.deleteStorageValue = function(id, resultHandler) {
    if (this.storage) {
      this.storage.deleteStorageValue(id, pluginId);
      return resultHandler(true);
    } else {
  ...
  ClusterManager.prototype.getStorage = function(pluginId) {
    return this.callClusterMethodRemote(null, "clusterManager", "getStorage", [pluginId],
  ...
  ClusterManager.prototype.setStorageValue = function(pluginId, id, value) {
    return this.callClusterMethodRemote(null, "clusterManager", "setStorageValue", [pluginId, id, value],
      function(resultHandler) {
  ...
  /* Though set here can be called like sync, we provide a callback in case we need
  to wait for a set response */
  ClusterManager.prototype.setStorage = function(pluginId, dict) {
    return this.callClusterMethodRemote(null, "clusterManager", "setStorage", [pluginId, dict],
      function(resultHandler) {
        return resultHandler[0];
      },
      function(e) {
  ...
  ClusterManager.prototype.addStorage = function(pluginId, dict) {
    return this.callClusterMethodRemote(null, "clusterManager", "addStorage", [pluginId, dict],
      function(resultHandler) {
        return resultHandler[0];
      },
      function(e) {
  ...
  ClusterManager.prototype.getStorageValue = function(pluginId, id) {
    return this.callClusterMethodRemote(null, "clusterManager", "getStorageValue", [pluginId, id],
    function(resultHandler) { 
      return resultHandler[0]; // Return the first arg (storage object) of getStorage
    },
    function(e) {
  ...
  ClusterManager.prototype.deleteStorageValue = function(pluginId, id) {
    this.callClusterMethod(null, "clusterManager", "deleteStorageValue", [pluginId, id],
      function(resultHandler) {
        return resultHandler[0];
      },
      function(e) {
