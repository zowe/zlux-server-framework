...
var storageTimeout = 2; /* Default timeout for how long plugins wait for the cluster storage to finish creation */
...
if (cluster.isMaster) {
  ...
  ClusterManager.prototype.setStorageAll = function(pluginId, dict, resultHandler) {
    if (this.storage) {
      ...
      this.storage.setAll(allStorage);
      return resultHandler(true);
    } else {
