...
ApimlConnector.prototype = {
  ...
  _makeMainInstanceProperties(overrides) {
    ...
    Object.assign(instance,  {
       instanceId: `${this.hostName}:zlux:${this.httpPort}`,
       hostName:  this.hostName,
       ipAddr: this.ipAddr,
       vipAddress: "zlux",//this.vipAddress,
       statusPageUrl: `${proto}://${this.hostName}:${this.httpPort}/server/eureka/info`,
       healthCheckUrl: `${proto}://${this.hostName}:${this.httpPort}/server/eureka/health`,
       homePageUrl: `${proto}://${this.hostName}:${this.httpPort}/`,
       port: {
         "$": Number(this.httpPort),
         "@enabled": true
       },
       securePort: {
         "$": Number(port),
