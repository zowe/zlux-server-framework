...
exports.log = global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.json");
class JSONUtils {
    constructor() {
    }
    readJSONFileWithComments(filename) {
...
function parseJSONWithComments(filename) {
    let test = new JSONUtils();
    return test.readJSONFileWithComments(filename);
}
