...
const isHaMode = module.exports.isHaMode = function () {
  const zoweInstanceId = process.env['ZOWE_INSTANCE'];
  const zoweHaInstanceId = process.env['ZWELS_HA_INSTANCE_ID'];
  return zoweInstanceId && zoweHaInstanceId;
}

module.exports.generateHaSessionId = function (request) {
...
module.exports.regenerateSessionId = function (req) {
