  ...
  fileList.forEach(function(filePath) {
    try {
      ...
      if(extension == 'p12'){
        ...
        let p12 = forge.pkcs12.pkcs12FromAsn1(p12Asn1, process.env.KEYSTORE_PASSWORD || "");
        let certData = p12.getBags({bagType: forge.pki.oids.certBag});
        let certBag = certData[forge.pki.oids.certBag][0];
