...
function DataserviceStorage(id) {
  ...
  this.getStorageByKey = function (key, pluginId) {
    const identifier = pluginId || this.pluginId;

    if (this.storageDict[identifier]) {
      if (this.storageDict[identifier][key]) {
        return this.storageDict[identifier][key];
      } else {
        return null;
      }
    }
  ...
  this.getStorageAll = function (pluginId) {
    ...
    /* Otherwise, return an empty set. This isn't null because things break when the top-most layer isn't defined */
    return {};
  }

  this.setStorageByKey = function (key, value, pluginId) {
    const identifier = pluginId || this.pluginId;
  ...
  this.setStorageAll = function (dict, pluginId) {
    const identifier = pluginId || this.pluginId;

    if (identifier) {
      this.storageDict[identifier] = dict;
    } else {
      console.warn("No specified plugin identifier to set storage value");
    }
  }

  this.deleteStorageByKey = function (key, pluginId) {
    const identifier = pluginId || this.pluginId;

    if (this.storageDict[identifier]) {
      if (this.storageDict[identifier][key]) {
        delete this.storageDict[identifier][key];
      } else {
