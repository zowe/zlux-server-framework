...
module.exports.isClientAttls = function(zoweConfig) {
  return zoweConfig.zowe.network?.client?.attls || zoweConfig.components['app-server'].zowe?.network?.client?.attls;
}
