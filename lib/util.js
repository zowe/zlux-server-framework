...
function makeAgentFakeSwaggerPlugin() {
  const agentFakeSwaggerPluginDef = {
    "identifier": "org.zowe.agent.swagger",
    "apiVersion": "1.0.0",
    "pluginVersion": "1.0.0",
    ...
    "swagger":{
      ...
      {
        "name" : "security-mgmt-api",
        "version": "1.0.0"
      },
      {
        "name" : "server-plugins-api",
        "version": "1.0.0"
      }
    ],
    "host": 'agent',
  ...
  return agentFakeSwaggerPluginDef;
}

module.exports.agentSwaggerPlugin = makeAgentFakeSwaggerPlugin();
