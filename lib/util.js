...
module.exports.getPrefixForService = function getPrefixForService(serviceName, type, version) {
  let typePath = type || 'api';
  let versionPath = version || '1';
  return `/${serviceName}/${typePath}/v${versionPath}`;
};
  
module.exports.getGatewayUrlForService = function getGatewayUrlForService(zoweConfig, includeProtocol, serviceName, type, version) {
