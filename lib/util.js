...
const { configJSON } = require(`../../zlux-app-server/lib/zluxArgs`)();
const logLanguage = configJSON.logLanguage;
var messages;
...
try { // Attempt to get a log message for a language a user may have specified
  ...
  messages = logFile;
    ...
    catch { // If all else fails, create loggers without specified messages
      messages = undefined;
    }
  }

const loggers = {
  bootstrapLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.bootstrap", messages),
  authLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.auth", messages),
  contentLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.static", messages),
  childLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.child", messages),
  utilLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.utils", messages),
  proxyLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.proxy", messages),
  installLogger: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.install", messages),
  apiml: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.apiml", messages),
  routing: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.routing", messages),
  network: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.network", messages),
  langManager: global.COM_RS_COMMON_LOGGER.makeComponentLogger("_zsf.lang", messages)
};
