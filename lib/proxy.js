...
function makeWsProxy(host, port, urlPrefix, overriddenOptions) {
  ...
  return function(ws, req) {
    ...
    const { isHttps, tlsOptions, allowInvalidTLSProxy } = overriddenOptions;
    if (isHttps) {
      options.rejectUnauthorized = !allowInvalidTLSProxy;
      if (tlsOptions) {
