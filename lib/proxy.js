...
function makeSimpleProxy(host, port, options, pluginID, serviceName) {
  ...
  return function(req1, res1) {
    ...
    console.trace(`httpApi.request requestOptions ${JSON.stringify(requestOptions, (key, value) => {if (Array.isArray(value) && value.length > 128) { return 'replaced'} return value; }, 2)}`);
