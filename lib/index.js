...
Server.prototype = {
  ...
  start: Promise.coroutine(function*() {
    ...
    webAppOptions.isProxiedHttps = proxiedOptions.protocol == 'https:' ? true : false;
    ...
    const pluginContext = {
      ...
      server: {
        config: {
          ...
          hosts: {
            hostname: this.webApp.options.hostname,
            httpPort: this.webApp.options.httpPort, 
            httpsPort: this.webApp.options.httpsPort, 
            agentHost: this.webApp.options.proxiedHost,
            agentPort: this.webApp.options.proxiedPort,
            isAgentHttps: this.webApp.options.isProxiedHttps
          }
        },
        state: {
