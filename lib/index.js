...
Server.prototype = {
  ...
  start: Promise.coroutine(function*() {
    ...
    if(this.userConfig.agent.mediationLayer) {
      webAppOptions.isProxiedHttps = this.userConfig.agent.mediationLayer.enabled;
    } else if(this.userConfig.agent.https) {
      webAppOptions.isProxiedHttps = this.userConfig.agent.https.port > ''
    }
      ...
      server: {
        config: {
          ...
          hosts: {
            ...
            proxiedHost: this.webApp.options.proxiedHost,
            proxiedPort: this.webApp.options.proxiedPort,
            isProxiedHttps: this.webApp.options.isProxiedHttps
          }
        },
        state: {
