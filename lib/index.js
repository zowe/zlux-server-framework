  ...
  start: Promise.coroutine(function*() {
    ...
    */
    ...
    if (this.userConfig.node.mediationLayer.enabled) {
      ...
      const eureka = this.apiml.zluxServerEurekaClient;
      ...
      eureka.once('registryUpdated', () => {
        console.log('registry updated');
        const zluxInstances = eureka.getInstancesByVipAddress('ZLUX');
        console.log(`zluxInstances ${JSON.stringify(zluxInstances, null, 2)}`);
