...
//        }
  ...
  getApiCatalog(productCode, nodeContext, hostsContext) {
    return makeSwaggerCatalog(this, productCode, nodeContext, hostsContext);
  }
...
PluginLoader.prototype = {
  ...
  readPluginDefs() {
    ...
    defs.push(zluxUtil.agentSwaggerPlugin);
    return defs;
  },
