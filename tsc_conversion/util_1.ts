...
module.exports.resolveRelativePaths = function resolveRelativePaths(root: any, resolver: any, relativeTo: any) {
...
module.exports.makeOptionsObject = function (defaultOptions: any, optionsIn: any) {
  const o = Object.create(defaultOptions);
  Object.assign(o, optionsIn);
  return Object.seal(o);
};

module.exports.clone = function(obj: any) {
  return JSON.parse(JSON.stringify(obj));
};

module.exports.deepFreeze = function deepFreeze(obj: any, seen: any) {
  if (!seen) {
    seen = new Map();
  }
  if (seen.get(obj)) {
...
module.exports.readOnlyProxy = function readOnlyProxy(obj: any) {
...
module.exports.getOrInit = function(obj: any, key: any, dflt: any) {
  let value = obj[key];
  if (!value) {
    value = obj[key] = dflt;
  }
...
module.exports.readFilesToArray = function(fileList: any[]) {
  var contentArray = [];
...
module.exports.makeErrorObject = function makeError(details: any) {
 ...
 */
module.exports.asyncEventListener = function(listenerFun: any, logger: any) {
...
module.exports.getLoopbackAddress = function getLoopbackAddress(listenerAddresses: any) {
...
module.exports.normalizePath = function(oldPath: any, relativeTo: any) {
